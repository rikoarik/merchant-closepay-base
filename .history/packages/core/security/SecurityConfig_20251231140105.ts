...
// Build config conditionally - only include androidConfig if we have certificate hashes
// FreeRASP requires certificateHashes to be defined and non-empty
export const securityConfig: TalsecConfig = {
  // Only include androidConfig if we have certificate hashes
  // FreeRASP will skip Android protection if androidConfig is omitted
