...
export const BottomSheet: React.FC<BottomSheetProps> = ({
  ...
  // Extract RGB dari colors.backdrop (rgba format) dan gunakan opacity animation
  ...
  const backdropColor = useMemo(() => {
    ...
    if (rgbaMatch) {
      ...
      const g = rgbaMatch[2];
      const b = rgbaMatch[3];
      // Return RGB tanpa alpha, opacity akan dikontrol oleh animatedBackdropStyle
      return `rgb(${r}, ${g}, ${b})`;
    }
    // Fallback ke hitam solid jika parsing gagal
    return '#000000';
  }, [colors.backdrop]);
