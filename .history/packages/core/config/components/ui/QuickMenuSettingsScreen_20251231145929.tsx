...
export const QuickMenuSettingsScreen: React.FC = () => {
  ...
  // Icon mapping function - memoized with useCallback to prevent re-creation
    ...
    >
      ...
      <ScrollView
        ...
        contentContainerStyle={[
          ...
          { paddingHorizontal: getHorizontalPadding() },
          !hasEnabledItems && menuItems.length > 0 && styles.scrollContentCentered,
        ]}
        showsVerticalScrollIndicator={false}
      >
        {!hasEnabledItems && menuItems.length > 0 ? (
      ...
      {/* Footer - Show buttons if has enabled items, otherwise show empty message */}
      {hasEnabledItems ? (
        <View
          style={[
            styles.footer,
        ...
        >
          ...
          >
            {t('profile.noMenuEnabled') || 'Tidak ada menu yang diaktifkan'}
          </Text>
        </View>
      )}
